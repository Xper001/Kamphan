...
local Window = Rayfield:CreateWindow({
   Name = "Hunty Zombies - Script By Iliankytb",
...
if zombies:IsA("Model") and zombies.Head.EntityHealth.HealthBar.Bar.Size.X.Scale ~= 0 and not InSafePos and not InCollecting and not InEscaping and not InteractedWithGen and not Game.Players.LocalPlayer:GetAttribute("escaped") then 
...
for I = 1,9 do 
task.spawn(function()
game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool"):SetAttribute("lastActivated"..I-1,game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool"):GetAttribute("lastActivated"..I-1)+500)
end)
task.wait(0.1) 
end
task.wait(0.1) end
...
task.spawn(function()
if k:isA("BasePart") and not InSafePos and  not InEscaping and not Game.Players.LocalPlayer:GetAttribute("escaped") then
InCollecting = true
